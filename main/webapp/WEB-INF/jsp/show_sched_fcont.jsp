		                ...
		                <form action="/show_sched_results" method="post" target="_blank">
		                  	<div class="w3-section">
		                    	...
		                    	<!--  when removing REQUIRED go to MainController, show_schedule, and in method show_schedule remove required=true 
		                    			for the employee_id -->
		                    	<input class="w3-input w3-border" type="text" name="employee_id" required> <!-- input field for entering the employee_id -->
		                  	</div>
		                  	<div class="w3-section">
		                    	...
		                    	<!--  when removing REQUIRED go to MainController, show_schedule, and in method show_schedule remove required=true 
		                    		  for the employee_id -->
		                    	<input class="w3-input w3-border" type="text" name="first_name" required> <!-- input field for entering the first_name -->
		                  	</div>
		                  	<div class="w3-section">
		                    	...
		                    	<!--  when removing REQUIRED go to MainController, show_schedule, and in method show_schedule remove required=true
		                    		   for the last-name -->
		                    	<input class="w3-input w3-border" type="text" name="last_name" required> <!-- input field for entering the last_name -->
		                  	</div>
		                  	<div class="w3-section">
